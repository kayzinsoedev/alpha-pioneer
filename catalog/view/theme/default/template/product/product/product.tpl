      	...
      	setTimeout(function(){
		  	<?php if ($vertical_slider) { ?>
		  		$('.product-image-additional').slick({
		  			...
		  			infinite: false,
		  			vertical: true,
		  			prevArrow: "<div class='pointer slick-nav left prev'><div class='absolute position-center-center'>
						<img src='image/catalog/general/up.png' alt='left-arrow'>
						</div></div>",
		  			nextArrow: "<div class='pointer slick-nav right next'><div class='absolute position-center-center'>
						<img src='image/catalog/general/down.png' alt='right-arrow'>
						</div></div>",
		  		});
		  	<?php } else { ?>
