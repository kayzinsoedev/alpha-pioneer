...
<style>
    ...
    body .section-space:not(.slideshow.max-offset) {
        padding:calc(<?= $config_section_padding ?>/19.2 * 1vw) 0;
    }
    /* Header Letter Case */
...
/*
    ...
    /* Font Family */
    /* .text_menu_font, .header-container .header-menu #main-menu li, .header-container .header-menu #main-menu li a { font-family: <?= $text_menu_font ?> !important; }
